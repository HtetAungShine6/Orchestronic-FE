...
// import ClusterDetailsTable from "../components/cluster-details-table"

// export default function ClusterDetailPage() {
//   const params = useParams()
//   const id = params.id as string

//   // Fetch the cluster info to display name and details
...
//               </h2>
//               <div className="flex items-center gap-2">
//                 <Badge variant={cluster.cloudProvider === "AZURE" ? "default" : "secondary"}>
...
//         </div>
//       </div>
//       <ClusterDetailsTable clusterId={id} pageSize={10} />
//     </div>
//   )
// }
